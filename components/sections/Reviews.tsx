...
const Reviews = () => {
    ...
    return (
        <section
            ref={reviewsRef}
            id="reviews"
            className="relative bg-purple-dark -mt-20 xl:-mt-10 pt-40 md:pt-35 pb-70"
            style={{
        ...
        >
            <div className="mx-auto max-w-7xl px-6 sm:px-8">
                ...
                <div className="relative mt-16">
                    <div className="reviews-card grid md:grid-cols-3 gap-6 px-6 pb-6 sm:px-8 justify-center">
                        {reviews.map((review) => (
                            <article
                                key={review.name}
                                className="w-75 rounded-3xl border border-navy bg-navy p-7 xl:py-10 sm:w-85"
                            >
