...
const Contact = () => {
    ...
    return (
        <section
            id="contact"
            className="relative bg-white -mt-50 pt-40 md:pt-35 pb-20"
            style={{
        ...
        >
            ...
            <div className="hidden md:block">
                <div className="relative mx-auto mt-16 grid max-w-6xl xl:max-w-400 grid-cols-1 gap-8 px-6 sm:px-8 lg:grid-cols-2 lg:items-stretch">
                    <div className="h-full">
                        <div className="rounded-3xl border border-violet bg-navy p-8 xl:p-10">
                            <div className="flex items-start gap-4">
                                ...
                                <div className=" space-y-3">
                                    <p className="text-xs font-semibold uppercase tracking-wider text-mist/50">{t.contact.address}</p>
                                    <p className="mt-1 font-display text-lg font-semibold text-cloud">Frank Craeybeckxlaan 83, 2100 Durne Antwerpen, Belgium
                                    </p>
                                    <a
                                        href="https://maps.app.goo.gl/8zbiksGdZL7YLd939"
                                        target="_blank"
                                        ...
                                        className="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-amber hover:underline"
                                    >
                                        Frank Craeybeckxlaan 83, 2100 Durne Antwerpen, Belgium
                                        <MoveUpRightIcon className="h-5 w-5" />
                                    </a>
                                </div>
                            </div>
