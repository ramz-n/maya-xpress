...
const About = () => {
    return (
        <section id="about" className="relative bg-navy-light py-28 sm:py-36">
            ...
            <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-16 px-6 sm:px-8 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
                <div className="lg:sticky lg:top-32 lg:self-start">
                    ...
                    <div className="mt-10 rounded-3xl border border-violet/20 bg-linear-to-br from-navy p-7 shadow-glow">
                ...
                <div>
                    ...
                    <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-3">
                        {aboutFeatures.map((feature, idx) => {
                            ...
                            return <div
                                key={idx}
                                className="flex flex-col gap-2 items-center rounded-2xl border border-violet bg-violet/50 p-6 transition-colors hover:border-amber"
                            >
